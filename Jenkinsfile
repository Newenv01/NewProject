...
pipeline{
  ...
  environment {
    ...
    def ServerNames = SRV_Name.split('\\|')
    def ServerName = ServerNames[0]
    def RemotePath = ServerNAmes[1]
    def RMID = ServerNames[2]
  ...
  stages{
      ...
      steps{
           script {
			  ...
			  sh "echo \"${env.WORKSPACE}, ${ServerNames}, ${ServerName}, ${RemotePath}\""
